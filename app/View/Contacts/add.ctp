...
<?php echo $this->Form->create('Contact',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-lg-2 required" for="ContactEMAIL">Votre email : </label>
        <div class="col-lg-10">
    ...
    <div class="form-group">
        <label class="col-lg-2 required" for="ContactOBJET">Objet du message : </label>
        <div class="col-lg-10">
    ...
    <div class="form-group">
        <label class="col-lg-2 required" for="ContactMESSAGE">Message : </label>
        <div class="col-lg-10">
