...
<?php echo $this->Form->create('Periodicite'); ?>
	<fieldset>
		<legend><?php echo __('Edit Periodicite'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Periodicite.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Periodicite.id'))); ?></li>
