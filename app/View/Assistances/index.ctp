<div class="assistances index">
	...
	<tr>
		...
		<td class="actions">
                        ...
                        <?php echo '<span class="glyphicons eye_open" rel="popover" data-title="<h3>Assistance :</h3>" data-content="<contenttitle>Crée le: </contenttitle>'.h($assistance['Assistance']['created']).'<br/><contenttitle>Modifié le: </contenttitle>'.h($assistance['Assistance']['modified']).'" data-trigger="click" style="cursor: pointer;"></span>'; ?>&nbsp;
			<?php endif; ?>
                        <?php if (userAuth('profil_id')!='2' && isAuthorized('assistances', 'edit')) : ?>
                        <?php echo $this->Html->link('<span class="glyphicons pencil"></span>', array('action' => 'edit', $assistance['Assistance']['id']),array('escape' => false,'class'=>'showoverlay')); ?>&nbsp;
			<?php endif; ?>
                        <?php if (userAuth('profil_id')!='2' && isAuthorized('assistances', 'delete')) : ?>
                        <?php echo $this->Form->postLink('<span class="glyphicons bin"></span>', array('action' => 'delete', $assistance['Assistance']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer cette assistance ?')); ?>
                        <?php endif; ?>
                </td>
	</tr>
        <?php endforeach; ?>
