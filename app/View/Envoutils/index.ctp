<div class="envoutils index">
        <nav class="navbar toolbar marginright20">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtre OS <b class="caret"></b></a>
                     <ul class="dropdown-menu">
                     <li><?php echo $this->Html->link('Tous', array('action' => 'index',$pass0,3),array('class'=>'showoverlay'.subfiltre_is_actif($pass1,'3'))); ?></li>
                     <li class="divider"></li>
                     <li><?php echo $this->Html->link('OS', array('action' => 'index',$pass0,1),array('class'=>'showoverlay'.subfiltre_is_actif($pass1,'1'))); ?></li>
                     <li><?php echo $this->Html->link('Logiciels', array('action' => 'index',$pass0,0),array('class'=>'showoverlay'.subfiltre_is_actif($pass1,'0'))); ?></li>
                     </ul>
                </li>                  
                </ul> 
                <?php echo $this->Form->create("Envoutil",array('action' => 'search', 'class'=>'toolbar-form pull-right','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
	...
	<tr>
            ...
            <td class="actions">
                ...
                <?php echo $this->Form->postLink('<span class="glyphicons bin showoverlay notchange"></span>', array('action' => 'delete', $envoutil['Envoutil']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer cet outil ?')); ?>                    
                <?php endif; ?>                    
            </td>
	</tr>
<?php endforeach; ?>
