<div class="logiciels index">
        ...
        <nav class="navbar toolbar marginright20">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtre Etats <b class="caret"></b></a>
                     <ul class="dropdown-menu">
                     <li><?php echo $this->Html->link('Tous', array('action' => 'index',$pass0,'tous','tous',$pass3,$pass4),array('escape' => false,'class'=>'showoverlay'.subfiltre_is_actif(array($pass1,$pass2),array('tous','tous')))); ?></li>
                     <li class="divider"></li>
                     <?php
                        switch ($pass1):
                            case 'tous':
                     ...
                     <li><?php echo $this->Html->link('<span class="glyphicons '.$img_actif.'"></span> Actif', array('action' => 'index',$pass0,$pass1,$inverse_actif,$pass3,$pass4),array('escape' => false,'class'=>'showoverlay')); ?></li>                     
                     </ul>
                 </li>
               <!-- <li class="dropdown <?php echo filtre_is_actif($pass3,'tous'); ?>">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtre Env. <b class="caret"></b></a>
                     <ul class="dropdown-menu">
                     <li><?php echo $this->Html->link('Tous', array('action' => 'index',$pass0,$pass1,$pass2,'tous',$pass4),array('escape' => false,'class'=>'showoverlay'.subfiltre_is_actif($pass3,'tous'))); ?></li>
                     <li class="divider"></li>
                         <?php foreach ($types as $type): ?>
                            <li><?php echo $this->Html->link($type['Type']['NOM'], array('action' => 'index',$pass0,$pass1,$pass2,$type['Type']['id'],$pass4),array('escape' => false,'class'=>'showoverlay'.subfiltre_is_actif($pass3,$type['Type']['id']))); ?></li>
                         <?php endforeach; ?>
                      </ul>
                 </li>-->
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtre Outils <b class="caret"></b></a>
                     ...
                     <li class="divider"></li>
                         <?php foreach ($outils as $outil): ?>
                            <li><?php echo $this->Html->link($outil['Envoutil']['NOM'], array('action' => 'index',$pass0,$pass1,$pass2,$pass3,$outil['Envoutil']['id']),array('escape' => false,'class'=>'showoverlay'.subfiltre_is_actif($pass4,$outil['Envoutil']['id']))); ?></li>
                         <?php endforeach; ?>
                      </ul>
                 </li>                 
                <li class="divider-vertical-only"></li>
