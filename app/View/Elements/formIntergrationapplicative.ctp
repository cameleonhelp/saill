...
<?php echo $this->Form->create('Intergrationapplicative',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-lg-2 required" for="IntergrationapplicativeApplicationId">Application : </label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-2 required" for="IntergrationapplicativeTypeId">Type d'environnement : </label>
        <div class="col-lg-5">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-2 required" for="IntergrationapplicativeLotId">Lot : </label>
        <div class="col-lg-5">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-2 required" for="IntergrationapplicativeVersionId">Version : </label>
        <div class="col-lg-5">
            <?php if ($this->params->action == 'edit') { ?>
