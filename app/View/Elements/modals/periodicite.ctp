    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label class="col-md-2" for="ActionREPETITIONHWEEK">Toutes les : </label>
        ...
        <div class="form-group">
            <label class="col-md-2" for="ActionREPETITIONHDAY<?php echo date('N'); ?>">Jour : </label>
            <div class="col-md-9">
                <?php 
        ...
        <div class="form-group">
            <label class="col-md-2" for="ActionREPETITIONHLAST">Fin le : </label>
            <div class="col-md-5">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            <label class="col-md-2" for="ActionREPETITIONMMONTH">Tous les : </label>
            <div class="col-md-9  form-inline">
                <?php
        ...
        <div class="form-group">  
            <label class="col-md-2" for="ActionREPETITIONMDAY">Le : </label>
            <div class="col-md-9  form-inline">
                <?php
        ...
        <div class="form-group">                 
            <label class="col-md-2" for="ActionREPETITIONMLAST">Fin le : </label>
            <div class="col-md-5"> 
                <div class="input-group" style="margin-left: 0px;">
                <?php $today = new dateTime(); ?>
