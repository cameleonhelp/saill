...
<tr>
        ...
        <td><?php echo h(isset($societe['Societe']['MAIL']) ? $societe['Societe']['MAIL'] : ''); ?>&nbsp;<?php echo h(!empty($societe['Societe']['MAIL'])) ? '<a href="mailto:'.$societe['Societe']['MAIL'].'"><span class="glyphicons envelope notchange"></span></a>' : ''; ?></td>
        <td class="actions">
            ...
            <?php echo $societe['Societe']['id']>1 ? $this->Html->link('<span class="glyphicons pencil showoverlay notchange"></span>', array('action' => 'edit', $societe['Societe']['id']),array('escape' => false)) : ''; ?>&nbsp;
            <?php endif; ?>
...
<script>   
    $(document).on('keyup','#SocieteSEARCH',function (event){
        var url = "<?php echo $this->webroot;?>societes/search/";
