<nav class="navbar toolbar ">
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtre Etats <b class="caret"></b></a>
             <ul class="dropdown-menu">
                 <li><?php echo $this->Html->link('Tous', array('action'=> $passaction,'complet',$pass1,$pass2,$keyword),array('class'=>'showoverlay'.subfiltre_is_actif($pass0,'complet'))); ?></li>
             <li><?php echo $this->Html->link('Tous sans retour utilisateur', array('action'=> $passaction,'tous',$pass1,$pass2,$keyword),array('class'=>'showoverlay'.subfiltre_is_actif($pass0,'tous'))); ?></li>
             <li class="divider"></li>
                 <?php foreach ($etats as $etat): ?>
                    <li><?php echo $this->Html->link($etat['Utiliseoutil']['STATUT'], array('action'=> $passaction,$etat['Utiliseoutil']['STATUT'],$pass1,$pass2,$keyword),array('class'=>'showoverlay'.subfiltre_is_actif($pass0,$etat['Utiliseoutil']['STATUT']))); ?></li>
                 <?php endforeach; ?>
              </ul>
         </li>   
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtre Utilisateur <b class="caret"></b></a>
             ...
             <li class="divider"></li>
                 <?php foreach ($utilisateurs as $utilisateur): ?>
                    <li><?php echo $this->Html->link($utilisateur['Utilisateur']['NOM'].' '.$utilisateur['Utilisateur']['PRENOM'], array('action'=> $passaction,$pass0,$utilisateur['Utilisateur']['id'],$pass2,$keyword),array('class'=>'showoverlay'.subfiltre_is_actif($pass1,$utilisateur['Utilisateur']['id']))); ?></li>
                 <?php endforeach; ?>
              </ul>
        </li> 
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtre Outils <b class="caret"></b></a>
             ...
             <li class="divider"></li>
             <li class="muted marginleft10">Outils</li>
                 <?php foreach ($outils as $outil): ?>
                    <li><?php echo $this->Html->link($outil['Outil']['NOM'], array('action'=> $passaction,$pass0,$pass1,'O_'.$outil['Outil']['id'],$keyword),array('class'=>'showoverlay'.subfiltre_is_actif($pass2,'O_'.$outil['Outil']['id']))); ?></li>
                 <?php endforeach; ?>
             <?php endif; ?>
             <?php if(count($listes) > 0) : ?>
             <li class="divider"></li>
             <li class="muted marginleft10">Listes de diffusion</li>
                 <?php foreach ($listes as $liste): ?>
                    <li><?php echo $this->Html->link($liste['Listediffusion']['NOM'], array('action'=> $passaction,$pass0,$pass1,'L_'.$liste['Listediffusion']['id'],$keyword),array('class'=>'showoverlay'.subfiltre_is_actif($pass2,'L_'.$liste['Listediffusion']['id']))); ?></li>
                 <?php endforeach; ?>
             <?php endif; ?>
             <?php if(count($partages) > 0) : ?>                            
             <li class="divider"></li>
             <li class="muted marginleft10">Dossiers partagés</li>
                 <?php foreach ($partages as $partage): ?>
                    <li><?php echo $this->Html->link($partage['Dossierpartage']['NOM'], array('action'=> $passaction,$pass0,$pass1,'P_'.$partage['Dossierpartage']['id'],$keyword),array('class'=>'showoverlay'.subfiltre_is_actif($pass2,'P_'.$partage['Dossierpartage']['id']))); ?></li>
                 <?php endforeach; ?> 
             <?php endif; ?>
             </ul>
         </li>                 
        ...
        <ul class="nav navbar-nav toolbar pull-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" style="left: -205px;min-width: 250px;max-width: 250px;">
                    <li>
                        <?php echo $this->Form->create("Utiliseoutil",array('url' => array('action' => 'search',$pass0,$pass1,$pass2), 'class'=>'toolbar-form pull-right','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
...
<?php echo $this->element('modals/help',array('helpcontent' => $this->element('hlp/hlp-utiliseoutil'))); ?>  
...
<tr>
        ...
        <td class="actions">
            ...
            <?php echo $this->Form->postLink('<span class="glyphicons bin notchange"></span>', array('action' => 'delete', $utiliseoutil['Utiliseoutil']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer cette demande de droit ?')); ?>                    
            <?php endif; ?>
        </td>
</tr>
<?php endforeach; ?>
...
<script>
     ...
     $(document).ready(function () {
       $(document).on('click','#utilisateur_filter, #outil_filter',function(e){
           e.stoppropagation();
       });
