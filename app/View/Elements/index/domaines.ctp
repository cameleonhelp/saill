...
<tr>
        ...
        <td class="actions">
            ...
            <?php endif; ?>
            <?php $condition = userAuth('profil_id')==1 ? '1=1' : userAuth('entite_id') == $domaine['Domaine']['entite_id']; ?>
            <?php if (userAuth('profil_id')!='2' && isAuthorized('domaines', 'edit') &&  $condition) : ?>
            ...
            <?php endif; ?>
            <?php if (userAuth('profil_id')!='2' && isAuthorized('domaines', 'delete') &&  $condition) : ?>
            <?php echo $this->Form->postLink('<span class="glyphicons bin notchange"></span>', array('action' => 'delete', $domaine['Domaine']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer ce domaine ?')); ?>
            <?php endif; ?>
        </td>
</tr>
<?php endforeach; ?>
...
<script>
    $(document).ready(function () {     
        $(document).on('keyup','#DomaineSEARCH',function (event){
            var url = "<?php echo $this->webroot;?>domaines/search/";
