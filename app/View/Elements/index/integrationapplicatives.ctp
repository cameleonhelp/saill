...
if (count($this->params->data) > 0) :
    $keyword = $this->params->data['Intergrationapplicative']['SEARCH'];
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Filtre Version <b class="caret"></b></a>
             ...
             <?php if(count($versions) > 0): ?>
                 <?php foreach ($versions as $version): ?>
                    <li><?php echo $this->Html->link($version['Version']['NOM'], array('action' => $passaction,$pass0,$pass1,$pass2,$pass3,$pass4,$version['Version']['id'],$keyword),array('escape' => false,'class'=>'showoverlay'.subfiltre_is_actif($pass5,$version['Version']['id']))); ?></li>
                 <?php endforeach; ?>
             <?php endif; ?>
              </ul>
         </li>         
        ...
        <ul class="nav navbar-nav toolbar pull-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" style="left: -205px;min-width: 250px;max-width: 250px;">
                    <li>
                        <?php echo $this->Form->create("Intergrationapplicative",array('url' => array('action' => 'search',$pass0,$pass1,$pass2,$pass3,$pass4,$pass5), 'class'=>'toolbar-form pull-right','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
...
$(document).ready(function () {
    ...
    $(document).on('keyup','#IntergrationapplicativeSEARCH',function (event){
        var url = "<?php echo $this->webroot;?>intergrationapplicatives/search/<?php echo $pass0; ?>/<?php echo $pass1; ?>/<?php echo $pass2; ?>/<?php echo $pass3; ?>/<?php echo $pass4; ?>/<?php echo $pass5; ?>/";
