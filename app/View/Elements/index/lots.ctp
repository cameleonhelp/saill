...
if (count($this->params->data) > 0) :
    $keyword = $this->params->data['Lot']['SEARCH'];
        ...
        <ul class="nav navbar-nav toolbar pull-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" style="left: -205px;min-width: 250px;max-width: 250px;">
                    <li>
                        <?php echo $this->Form->create("Lot",array('url' => array('action' => 'search',$pass0,$pass1), 'class'=>'toolbar-form pull-right','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
...
<tr>
    ...
    <td><?php echo h($lot['Entite']['NOM']); ?>&nbsp;</td>
    ...
    <td class="actions">
        ...
        <?php echo $this->Form->postLink('<span class="glyphicons bin notchange"></span>', array('action' => 'delete', $lot['Lot']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer ce lot ?')); ?>                    
        <?php endif; ?>                    
    </td>
</tr>
<?php endforeach; ?>
...
$(document).ready(function () {
    ...
    $(document).on('keyup','#LotSEARCH',function (event){
        var url = "<?php echo $this->webroot;?>lots/search/<?php echo $pass0; ?>/<?php echo $pass1; ?>/";
