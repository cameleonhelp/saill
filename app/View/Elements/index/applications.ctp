...
if (count($this->params->data) > 0) :
    $keyword = $this->params->data['Application']['SEARCH'];
        ...
        <ul class="nav navbar-nav toolbar pull-right">
            <li class="dropdown">
                ...
                <ul class="dropdown-menu" style="left: -205px;min-width: 250px;max-width: 250px;">
                    <li>
                        <?php echo $this->Form->create("Application",array('url' => array('action' => 'search',$pass0,$pass1), 'class'=>'toolbar-form pull-right','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
...
<tr>
        ...
        <td><?php echo h($application['Entite']['NOM']); ?>&nbsp;</td>
...
$(document).ready(function () {
    ...
    $(document).on('keyup','#ApplicationSEARCH',function (event){
        var url = "<?php echo $this->webroot;?>applications/search/<?php echo $pass0; ?>/<?php echo $pass1; ?>/";
