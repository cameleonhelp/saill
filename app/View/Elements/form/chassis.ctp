...
<?php echo $this->Form->create('Chassis',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="ChassisNOM">Nom : </label>
        <div class="col-md-5">
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="ChassisLocaliteId">Localisation : </label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="ChassisNIVEAU">Niveau : </label>
        <div class="col-md-2">
    ...
    <div class="form-group">
        <label class="col-md-2" for="ChassisARMOIRE">Armoire : </label>
        <div class="col-md-4">
            <?php echo $this->Form->input('ARMOIRE',array('type'=>'text','placeholder'=>'Armoire','class'=>'form-control')); ?>
        </div>
    </div>  
    <div class="form-group">
        <label class="col-md-2" for="ChassisPVU">PVU : </label>
        <div class="col-md-4">
            <?php echo $this->Form->input('PVU',array('type'=>'text','placeholder'=>'PVU','class'=>'form-control')); ?>
        </div>
    </div>       
    <div class="form-group">
        <label class="col-md-2" for="ChassisEntiteId">Cercle de visibilité : </label>
        <div class="col-md-4">
            <?php if ($this->params->action == 'edit') { ?>
                <?php echo $this->Form->select('entite_id',$cercles,array('class'=>'form-control','selected' => $this->data['Chassis']['entite_id'],'empty' => 'Choisir un cercle de visibilité ou visible par tous')); ?>
            <?php } else { ?>
