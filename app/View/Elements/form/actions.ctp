...
<?php echo $this->Form->create('Action',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    ...
    <div class="block-panel-50-left">
        ...
        <div class="form-group">
            <label class="col-md-4" for="ActionDUREEPREVUE">Charge prévue : </label>
    ...
    <!--Onglet pour avoir un affichage plus compact-->
    <ul class="nav nav-tabs" id="tabdetail">
      ...
      <li><a href="#commentaire" data-toggle="tab"><span class="glyphicons notchange <?php echo $sapnright; ?>"></span>&nbsp;Commentaire</a></li>
      <?php if ($this->params->action == 'edit'): ?><li><a href="#bilan" data-toggle="tab"><span class="glyphicons notchange <?php echo $this->data['Action']['BILAN']!='' ? "edit" : "unchecked"; ?>"></span>&nbsp;Bilan/Résultat</a></li>
      <li><a href="#livrable" data-toggle="tab">Livrables associés</a></li>
      <li><a href="#history" data-toggle="tab">Historique</a></li><?php endif; ?>
    </ul>
    <!--Contenu des onglets-->
    <div class="tab-content">
        ...
        <div class="form-group">
            ...
            <label class="col-md-2" for="ActionREPETITIONQ">Périodicité de l'échéance</label>
            <div class="col-md-10 inline_labels" >
                 <?php
            ...
            <div class="form-group">
                <label class="col-md-2" for="ActionCRA">CRA : </label>
                <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10"> 
                  ...
                  <!-- /test modal //-->                      
                  <div class="bs-callout bs-callout-warning info-risque" style="width:100%;margin-top:21px;margin-bottom: -7px;">Vous pouvez ajouter un commentaire ci-dessous pour justifier le risque<br>
                      <div class="form-group" style="margin-bottom:-5px;"><div class="col-md-12"><?php echo $this->Form->input('COMMENTRISK',array('type'=>'text','class'=>'form-control')); ?> </div></div>
                  </div>
                </div>
            </div>                
            <div class="form-group">
        ...
        <div class="tab-pane fade" id="commentaire"><p>
            <?php echo $this->Form->input('COMMENTAIRE'); ?> 
        </p></div>
        <?php if ($this->params->action == 'edit'): ?>
        <div class="tab-pane fade" id="bilan"><p>
            <?php echo $this->Form->input('BILAN',array('type'=>'textarea')); ?> 
        </p></div>
        <div class="tab-pane fade" id="livrable"><p>
        ...
        <div class="tab-pane fade" id="history"><p>
            <?php echo $this->element('tableHistoryAction'); ?>
        </p></div>
        <?php endif; ?>
    </div>  
    </div>
