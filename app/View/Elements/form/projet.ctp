...
<?php echo $this->Form->create('Projet',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="ProjetContratId">Contrat : </label>
        <div class="col-md-5">
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="ProjetNOM">Nom : </label>
        <div class="col-md-5">
...
<div class="form-group">
        <label class="col-md-2" for="ProjetDEBUT">Début du projet : </label>
        <div class="col-md-3">
            <div class="input-group" style="margin-left: 0px;">
    ...
    <div class="form-group">
        <label class="col-md-2" for="ProjetFIN">Fin du projet : </label>
        <div class="col-md-3">
            <div class="input-group" style="margin-left: 0px;">
            <?php $today = new dateTime(); ?>
    ...
    <div class="form-group">
        <label class="col-md-2" for="ProjetACTIF">Actif : </label>
        <div class="col-md-5">
    ...
    <div class="form-group">
        <label class="col-md-2" for="ProjetTYPE">Type : </label>
        <div class="col-md-3">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-md-2" for="ProjetFACTURATION">Facturation : </label>
        <div class="col-md-3">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-md-2" for="ProjetCOMMENTAIRE">Commentaire : </label>
        <div class="col-md-10">
