<?php echo $this->Form->create('Suivilivrable',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-4 control-label" for="SuivilivrableECHEANCE">Echéance de livraison : </label>
    ...
    <div class="form-group">
        <label class="col-md-4 control-label" for="SuivilivrableDATELIVRAISON">Date de livraison : </label>
        <div class="col-md-offset-4 form-control">
    ...
    <div class="form-group">
        <label class="col-md-4 control-label" for="SuivilivrableDATEVALIDATION">Date de validation : </label>
        <div class="col-md-offset-4 form-control">
    ...
    <div class="form-group">
        <label class="col-md-4 control-label" for="SuivilivrableETAT">Poste informatique : </label>
        <div class="col-md-offset-4 form-control">
