...
<table>  
    <tr>
    <td>
        <label class="col-md-4 control-label  required" for="AffectationActiviteId">Activité : </label>
    </td>
    <td>
    ...
    <td>
        <label class="col-md-4 control-label" for="AffectationREPARTITION">Clé de répartition : </label>
    </td>
    <td>
