...
<?php echo $this->Form->create('Logiciel',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="LogicielNOMDISABLED">Nom : </label>
        <div class="col-md-5">
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="LogicielEnvoutilId">Outil : </label>
        <div class="col-md-5">
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="LogicielEnvversionId">Version : </label>
        <div class="col-md-5">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="LogicielApplicationId">Application : </label>
        <div class="col-md-5">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="LogicielLotId">Lot : </label>
        <div class="col-md-5">
            <?php if ($this->params->action == 'edit') { ?>
