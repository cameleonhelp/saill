...
<?php echo $this->Form->create('Architecture',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="ArchitectureNOM">Nom : </label>
        <div class="col-md-5">
    ...
    <div class="form-group">
        <label class="col-md-2" for="ArchitectureEntiteId">Cercle de visibilité : </label>
        <div class="col-md-3">
            <?php if ($this->params->action == 'edit') { ?>
                <?php echo $this->Form->select('entite_id',$cercles,array('class'=>'form-control','selected' => $this->data['Architecture']['entite_id'],'empty' => 'Choisir un cercle de visibilité ou visible par tous')); ?>
            <?php } else { ?>
    ...
    <div class="form-group">
        <label class="col-md-2" for="ArchitectureCOMMENTAIRE">Commentaire : </label>
        <div class="col-md-10">
