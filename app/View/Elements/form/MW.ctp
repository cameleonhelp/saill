...
<?php echo $this->Form->create('Mw',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="MwNOMDISABLED">Nom : </label>
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="MwEnvoutilId">Logiciel : </label>
        <div class="col-md-3">
    ...
    <div class="form-group">
        <label class="col-md-2" for="MwEntiteId">Cercle de visibilité : </label>
        <div class="col-md-3">
            <?php if ($this->params->action == 'edit') { ?>
                <?php echo $this->Form->select('entite_id',$cercles,array('class'=>'form-control','selected' => $mw['Mw']['entite_id'],'empty' => 'Choisir un cercle de visibilité ou visible par tous')); ?>
            <?php } else { ?>
