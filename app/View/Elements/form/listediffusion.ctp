...
<?php echo $this->Form->create('Listediffusion',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="ListediffusionNOM">Nom : </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
            <label class="col-md-2" for="LivrableUtilisateurId">Gestionnaire : </label>
            <div class="col-md-5">  
        ...
        <div class="form-group">
        <label class="col-md-2" for="ListediffusionDESCRIPTION">Description : </label>
        <div class="col-md-10">
