...
<?php echo $this->Form->create('Materielinformatique',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2  required" for="MaterielinformatiqueNOM">Nom : </label>
        <div class="col-md-3">
    ...
    <div class="form-group">
        <label class="col-md-2  required" for="MaterielinformatiqueTypematerielId">Périphérique : </label>
        <div class="col-md-3">
    ...
    <div class="form-group">
        <label class="col-md-2  required" for="MaterielinformatiqueSectionId">Section : </label>
        <div class="col-md-3">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-md-2  required" for="MaterielinformatiqueAssistanceId">Assistance : </label>
        <div class="col-md-3">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-md-2" for="MaterielinformatiqueWIFI">Wifi : </label>
        <div class="col-md-5">
    ...
    <div class="form-group">
        <label class="col-md-2" for="MaterielinformatiqueVPN">Accès distant : </label>
        <div class="col-md-5">
    ...
    <div class="form-group">
        <label class="col-md-2  required" for="MaterielinformatiqueEtat">Etat : </label>
        <div class="col-md-3">
            <?php if ($this->params->action == 'edit') { ?>
        ...
        <div class="form-group">
        <label class="col-md-2" for="MaterielinformatiqueCOMMENTAIRE">Description : </label>
        <div class="col-md-10">
