...
<?php echo $this->Form->create('Tjmcontrat',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="TjmcontratTJM">Montant du TJM contrat : </label>
        <div class='row'>
        <div class="col-md-2">
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="TjmcontratANNEE">Année d'application : </label>
        <div class="col-md-2">
