...
<?php echo $this->Form->create('Livrable',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    ...
    <div class="col-md-6">
        <div class='form-group'>
        <label class="col-md-4" for="LivrableDATEVALIDATION">Date de validation : </label>
        <div class="col-md-6">
            <div class="input-group" style="margin-left: 0px;margin-right: 0px;">
            <?php $today = new dateTime(); ?>
    ...
    <div class="col-md-6">
        <div class='form-group'>
        <label class="col-md-4" for="LivrableDATELIVRAISON">Livraison</label>
        <div class="col-md-6">
            <div class="input-group" style="margin-left: 0px;margin-right: 0px;">
            <?php $today = new dateTime(); ?>
    ...
    <div class="form-group">
        <label class="col-md-2" for="LivrableCOMMENTAIRE">Commentaire : </label>
        <div class="col-md-10">
