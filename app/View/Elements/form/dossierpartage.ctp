...
<?php echo $this->Form->create('Dossierpartage',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="DossierpartageNOM">Nom : </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
        <label class="col-md-2 required" for="DossierpartageGROUPEAD">Nom du groupe: </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
        <label class="col-md-2" for="DossierpartageUtilisateurId">Gestionnaire: </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
        <label class="col-md-2" for="DossierpartageDESCRIPTION">Description : </label>
        <div class="col-md-10">
