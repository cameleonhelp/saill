...
<?php echo $this->Form->create('Section',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="SectionNOM">Nom : </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
        <label class="col-md-2" for="SectionUtilisateurId">Responsable : </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
            <label class="col-md-2" for="SectionMAILVALIDEUR">Mail du valideur : </label>
            <div class="col-md-10">
                <?php echo $this->Form->input('MAILVALIDEUR',array('class'=>'form-control','placeholder'=>'Email du valideur')); ?>   
            </div>
        </div>        
        <div class="form-group">
            <label class="col-md-2" for="SectionMAILGESTANNUAIRE">Mail du gestionnaire d'annuaire : </label>
            <div class="col-md-10">
                <?php echo $this->Form->input('MAILGESTANNUAIRE',array('class'=>'form-control','placeholder'=>'Email du gestionnaire d\'annuaire')); ?>   
            </div>
        </div>     
        <div class="form-group">
        <label class="col-md-2" for="SectionDESCRIPTION">Description : </label>
        <div class="col-md-10">
