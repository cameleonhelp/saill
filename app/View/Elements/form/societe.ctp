...
<?php echo $this->Form->create('Societe',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="SocieteNOM">Nom : </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
        <label class="col-md-2" for="SocieteNOMCONTACT">Nom du contact : </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
        <label class="col-md-2" for="SocieteTELEPHONE">Téléphone : </label>
        <div class="col-md-5">
        ...
        <div class="form-group">
        <label class="col-md-2" for="SocieteMAIL">Email du contact : </label>
        <div class="col-md-5">
