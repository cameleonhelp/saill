...
<?php echo $this->Form->create('Activite',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2 required" for="ActiviteProjetId">Projet : </label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <label class="col-md-2  required" for="ActiviteNOM">Nom : </label>
        <div class="col-md-6">
    ...
    <div class="form-group">
        <label class="col-md-2" for="ActiviteNUMEROGALLILIE">Réf. GALILEI : </label>
        <div class="col-md-3">
...
<div class="form-group">
        <label class="col-md-2" for="ActiviteDATEDEBUT">Début de l'activité : </label>
        <div class="col-md-3">
            <div class="input-group" style="margin-left: 0px;">
    ...
    <div class="form-group">
        <label class="col-md-2" for="ActiviteDATEFIN">Fin de l'activité : </label>
        <div class="col-md-3">
            <div class="input-group" style="margin-left: 0px;">
            <?php $today = new dateTime(); ?>
    ...
    <div class="form-group">
        <label class="col-md-2" for="ActiviteACTIVE">Actif : </label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <label class="col-md-2" for="ActiviteDELETABLE">Supprimable : </label>
        <div class="col-md-4">
    ...
    <?php if($this->params->action=='edit') : ?>
    <div class="form-group">
        <label class="col-md-2" for="ActiviteBUDJETRA">Budget initial : </label>
        <div class="row">
            <div class="col-md-2">
    ...
    <div class="form-group">
        <label class="col-md-2" for="ActiviteBUDGETREVU">Dernier budget : </label>
        <div class="row">
            <div class="col-md-2">
    ...
    <div class="form-group">
            <label class="col-md-2">Historique budget : </label>
            <div class="col-md-10"><?php echo $this->element('tableHistoryBudget'); ?></div>
    </div>
    <?php else : ?>
    <div class="form-group">
    <label class="col-md-2">Budgets : </label>
    <div class="col-md-4"><em>Vous pouvez ajouter un nouveau budget après l'enregistrement de l'activité</em></div>
    </div>
    <?php endif; ?>
    <div class="form-group">
        <label class="col-md-2" for="ActiviteDESCRIPTION">Commentaire : </label>
        <div class="col-md-10">
...
<!-- fenêtre modale //-->
<?php echo $this->element('modals/newbudget'); ?>