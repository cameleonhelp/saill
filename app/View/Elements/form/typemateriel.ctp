...
<?php echo $this->Form->create('Typemateriel',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
        <div class="form-group">
            <label class="col-md-2 required" for="TypematerielNOM">Nom : </label>
            <div class="col-md-5">
        ...
        <div class="form-group">
            <label class="col-md-2" for="TypematerielUC">UC / Portable : </label>
            <div class="col-md-10">
                    <?php echo $this->Form->input('UC',array('type'=>'checkbox','class'=>'yesno')); ?>
                    &nbsp;<label class='labelAfter' for="TypematerielUC"></label> 
            </div>
        </div>       
        <div class="form-group">
        <label class="col-md-2" for="TypematerielDESCRIPTION">Description : </label>
        <div class="col-md-10">
