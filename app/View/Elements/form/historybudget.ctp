...
<?php echo $this->Form->create('Historybudget',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-md-2  required" for="HistorybudgetANNE">Année : </label>
        <div class="col-md-4">
    ...
    <div class="form-group">
        <label class="col-md-2  required" for="HistorybudgetPREVU">Budget initial : </label>
        <div class="row">
            <div class="col-md-2">
    ...
    <div class="form-group">
        <label class="col-md-2" for="HistorybudgetREVU">Budget revu : </label>
        <div class="row">
            <div class="col-md-2">
    ...
    <div class="form-group">
        <label class="col-md-2" for="HistorybudgetACTIF">Budget actif : </label>
        <div class="col-md-4">
