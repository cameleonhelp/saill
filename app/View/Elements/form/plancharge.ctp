...
<?php echo $this->Form->create('Plancharge',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    ...
    <label class="col-md-2 required" for="PlanchargeANNEE">Année : </label>
    <div class="col-md-2">
    ...
    <div class="form-group">
    <label class="col-md-2 required" for="PlanchargeContratId">Contrat : </label>
    <div class="col-md-3">
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="PlanchargeNOM">Nom : </label>
    <div class="col-md-4">
    ...
    <div class="form-group">
        <label class="col-md-2 required" for="PlanchargeTJM">TJM : </label></td>
    <div class="col-md-2">
                <?php echo $this->Form->input('TJM',array('class'=>'text-right form-control','type'=>'text','style'=>"width:45px;",'placeholder'=>'TJM','data-rule-required'=>'true','data-msg-required'=>"Le TJM est obligatoire")); ?> €/j               
    </div>
    </div>
