...
<?php echo $this->Form->create('Dotation',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-lg-4" for="DotationMaterielinformatiquesId">Poste informatique : </label>
        <div class="col-lg-4">
    ...
    <div class="form-group">
        <label class="col-lg-4" for="DotationTypematerielId">ou Périphérique : </label>
        <div class="col-lg-4">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="DotationDATERECEPTION">Date de remise du matériel : </label>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="DotationDATEREMISE">Date de retour du matériel : </label>
        <div class="col-lg-3" style="margin-left:14px;">
            <div class="input-group">
            <?php $today = new dateTime(); ?>
