      ...
      <div id="administration" class="panel-collapse collapse panel-menu-content <?php echo classActive($classAdministration); ?>">
        <div class="panel-body">
          <ul>
            ...
            <li class="<?php echo $classTypeMateriels; ?>"><?php echo $this->Html->link('Types de matérel',array('controller'=>'typemateriels','action'=>'index'),array('class'=>'showoverlay','escape' => false)); ?></li>
            <?php endif; ?>  
          </ul>
        </div>
      </div>
      ...
      <div id="administrationenv" class="panel-collapse collapse panel-menu-content <?php echo classActive($classAdminEnv); ?>">
        <div class="panel-body">
          <ul>
            ...
            <li class="<?php echo $classCpus; ?>"><?php echo $this->Html->link('CPU',array('controller'=>'cpuses','action'=>'index'),array('class'=>'showoverlay','escape' => false)); ?></li>
            <?php endif; ?>             
...
<?php endif; ?>  
  ...
  <div class="scroll-btn-bottom"><span class="glyphicons up_arrow white"></span></div>
