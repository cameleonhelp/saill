<?php echo $this->Form->create('Outil',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('label'=>false,'div' => false))); ?>
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $this->Form->input('NOM',array('type'=>'text','data-rule-required'=>'true','data-msg-required'=>"Le nom de l'outil est obligatoire",'error' => array('attributes' => array('wrap' => 'span', 'style' => 'display:none;')))); ?>
        </div>
        </div>
    <div class="control-group">
