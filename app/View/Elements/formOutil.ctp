...
<?php echo $this->Form->create('Outil',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-lg-2 required" for="OutilNOM">Nom : </label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-2 required" for="OutilUtilisateurId">Gestionnaire : </label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-2" for="OutilVALIDATION">A faire valider : </label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-2" for="OutilDESCRIPTION">Description : </label>
        <div class="col-lg-10">
