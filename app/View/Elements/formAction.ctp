...
<?php echo $this->Form->create('Action',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-lg-2 required" for="ActionOBJET">Objet : </label>
        <div class="col-lg-10">
    ...
    <div class="block-panel-50-left">
        ...
        <div class="form-group">
            <label class="col-lg-4" for="ActionPRIORITE">Priorité : </label>
            <div class="col-lg-6">
                <?php if ($this->params->action == 'edit') { ?>
        ...
        <div class="form-group">
            <label class="col-lg-4" for="ActionDUREEPREVUE">Durée prévue : </label>
    ...
    <div class="block-panel-50-right">
        ...
        <div class="form-group">
            <label class="col-lg-4 required" for="ActionActiviteId">Activité : </label>
            <div class="col-lg-6">
        ...
        <div class="form-group">
            <label class="col-lg-4" for="ActionECHEANCE">Echéance de l'Action : </label>
            <div class="col-lg-5">
              <div class="input-group" style="margin-left: 0px;">
              <?php $today = new dateTime(); ?>
        ...
        <div class="form-group">
            <label class="col-lg-4" for="ActionSTATUT">Statut : </label>
            <div class="col-lg-6">
                <?php if ($this->params->action == 'edit') { ?>
        ...
        <div class="form-group">
            <label class="col-lg-4" for="ActionAVANCEMENT">Avancement : </label>
            <div class="col-lg-8 form-inline">
    ...
    <div class="form-group">
        ...
        <label class="col-lg-2" for="ActionRISK">Risque : </label>
        <div class="col-lg-10"> 
    ...
    <hr>   
    <div class="form-group">
        <label class="col-lg-2" for="ActionRESUME">Résumé : </label>
        <div class="col-lg-10">
