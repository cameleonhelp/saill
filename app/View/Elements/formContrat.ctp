...
<?php echo $this->Form->create('Contrat',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-lg-2 required" for="ContratNOM">Nom : </label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-2" for="ContratTjmcontratId">TJM Moyen : </label>
        <div class="col-lg-3">
    ...
    <div class="form-group">
        <label class="col-lg-2 required" for="ContratANNEEDEBUT">Début (année) : </label>
        <div class="col-lg-3">
    ...
    <div class="form-group">
        <label class="col-lg-2" for="ContratANNEEFIN">Fin (année) : </label>
        <div class="col-lg-3">
    ...
    <!--<div class="form-group">
        <label class="col-lg-2" for="ContratMONTANT">Montant (k€) : </label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-2" for="ContratACTIF">Actif : </label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-2" for="ContratDESCRIPTION">Commentaire : </label>
        <div class="col-lg-10">
