...
<div class="livrables index">
	...
	<tr>
		...
		<td style="text-align: center;"><?php echo h(isset($livrable['Livrable']['DATELIVRAISON']) ? $livrable['Livrable']['DATELIVRAISON'] : ''); ?>&nbsp;</td>
                ...
                <?php echo $this->Html->link('<i class="icon-trash"></i>', array('controller'=>'Actionslivrables','action' => 'delete', $livrable['Actionslivrable']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer cette association ?')); ?>                    
                <?php endif; ?>	
                </td>
        </tr>
<?php endforeach; ?>
