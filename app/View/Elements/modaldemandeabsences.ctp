        ...
        <div class="block-content">
            ...
            <?php echo $this->Form->create('Demandeabsence',array('action'=>'add','id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
                <div class="form-group">
                    <label class="col-lg-4 required" for="DemandeabsenceUtilisateurId">Demandeur : </label>
                    <div class="col-lg-8">
                ...
                <div class="form-group">
                    <label class="col-lg-4  required" for="DemandeabsenceDATEDU">Du (inclus) : </label>
                    <div class="row">
                        <div class="col-lg-4">
                        ...
                        <div><div class="col-lg-3"><?php
                        $options=array('8'=>'08:00','12'=>'13:00');
                        echo $this->Form->select('DATEDUTYPE',$options,array('default'=>'8','empty'=>false,'class'=>'form-control col-lg-2'));
                        ?></div></div>             
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-lg-4  required" for="DemandeabsenceDATEAU">Au (inclus) : </label>
                    <div class="row">
                        <div class="col-lg-4">
                          <div class="input-group" style="margin-left: 0px;">
                          <?php $today = new dateTime(); ?>
                          <?php echo $this->Form->input('DATEAU',array('type'=>'text','placeholder'=>'ex.: '.$today->format('d/m/Y'),'data-rule-required'=>'true','value'=>$today->format('d/m/Y'),'class'=>"form-control dateweek",'data-msg-required'=>"La date de début est obligatoire",'error' => array('attributes' => array('wrap' => 'span', 'style' => 'display:none;')))); ?>
                        ...
                        echo $this->Form->select('DATEAUTYPE',$options,array('default'=>'16','empty'=>false,'class'=>'form-control col-lg-2'));
                        ?></div></div>             
                    </div>
                </div>
                <div class="form-group">
