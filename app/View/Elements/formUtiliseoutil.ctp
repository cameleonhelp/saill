...
<?php echo $this->Form->create('Utiliseoutil',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    <div class="form-group">
        <label class="col-lg-2 required" for="UtiliseoutilUtilisateurId">Utilisateur : </label>
        <div class="col-lg-3">
    ...
    <div class="form-group">
        <label class="col-lg-2" for="UtiliseoutilOutilId">Outil : </label>
        <div class="col-lg-3">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-2" for="UtiliseoutilListediffusionId">Liste de diffusion : </label>
        <div class="col-lg-3">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-2" for="UtiliseoutilDossierpartageId">Partage réseau : </label>
        <div class="col-lg-3">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-2 required" for="UtiliseoutilSTATUT">Etat : </label>
        <div class="col-lg-3">
            <?php if ($this->params->action == 'edit') { ?>
