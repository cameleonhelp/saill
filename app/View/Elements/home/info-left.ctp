  ...
  <div class="panel panel-info">
    ...
    <div id="panel_navigateur_content" class="panel-collapse collapse">
      <div class="panel-body">
        <ul class="list-group">
          <li class="list-group-item"><a href="https://catalogue-solutions.sncf.fr/index.php/Firefox" target="_blank"><span class="glyphicons link notchange  margintop4 marginright10"></span></a>Firefox</li>
