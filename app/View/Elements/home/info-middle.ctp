<div class="panel-group" id="panel_apps">
  <div class="panel panel-info">
    ...
    $mylogiciels[]=array('nom'=>'TinyMCE','version'=>'4.1.0','date'=>'19/06/2014','url'=>'http://www.tinymce.com/','source'=>'https://github.com/tinymce/tinymce/releases/','description'=>"Transforme les éléments textarea en éditeur WYSWYG.");
    $mylogiciels[]=array('nom'=>'Filemanager','version'=>'9.5.0','date'=>'08/06/2014','url'=>'http://www.responsivefilemanager.com/','source'=>'https://github.com/trippo/ResponsiveFilemanager/releases/','description'=>"Plugin pour TinyMCE qui permet le chargement de fichier et/ou images.");
    ...
    $mylogiciels[]=array('nom'=>'MySQL Workbench','version'=>'6.1.6','date'=>'19/05/2014','url'=>'http://dev.mysql.com/downloads/tools/workbench/','source'=>'http://dev.mysql.com/downloads/tools/workbench/','description'=>"MySQL Workbench est un logiciel de gestion et d'administration de bases de données.");
    $mylogiciels[]=array('nom'=>'Highcharts/Highstock','version'=>'4.0.1/2.0.1','date'=>'25/04/2014','url'=>'http://www.highcharts.com','source'=>'https://github.com/highslide-software/highcharts.com/releases/','description'=>"Highcharts est une bibliothèque Javascript qui permet de faire une panoplie de graphique.");
    ...
    $mylogiciels[]=array('nom'=>'Colopicker','version'=>'2.0.0','date'=>'16/06/2014','url'=>'http://mjolnic.github.io/bootstrap-colorpicker','source'=>'https://github.com/mjaalnir/bootstrap-colorpicker/releases/','description'=>"C'est une bibliothèque Javascript au même style que bootstarp pour choisir une couleur.");
    ...
    $mylogiciels[]=array('nom'=>'TableSorter','version'=>'2.17.2','date'=>'19/06/2014','url'=>'http://mottie.github.io/tablesorter/docs/','source'=>'https://github.com/Mottie/tablesorter/releases/','description'=>"C'est une bibliothèqe Javascript qui permet de faire des tris en cliquant sur les entêtes des tableaux.");
