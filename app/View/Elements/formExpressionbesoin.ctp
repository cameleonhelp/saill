...
<?php echo $this->Form->create('Expressionbesoin',array('id'=>'formValidate','class'=>'form-horizontal','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
    ...
    <div class="form-group">
        <label class="col-lg-4 required" for="ExpressionbesoinApplicationId">Application : </label>
        <div class="col-lg-8">
    ...
    <div class="form-group">
        <label class="col-lg-4 required" for="ExpressionbesoinPerimetreId">Périmètre : </label>
        <div class="col-lg-8">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinENVIRONNEMENT">Type d'environnement DSI-T: </label>
        <div class="col-lg-8">
                <?php echo $this->Form->input('ENVIRONNEMENT',array('class'=>'form-control','placeholder' => 'Type d\'environnement DSI-T')); ?>     
        </div>        
    </div>        
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinPhaseId">Phase : </label>
        <div class="col-lg-8">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinPuissanceId">Puissance : </label>
        <div class="col-lg-8">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinUSAGE">Usage : </label>      
        <div class="col-lg-8">
            <?php echo $this->Form->input('USAGE',array('type'=>'text','placeholder'=>'Usage','class'=>'form-control')); ?>
        </div>         
    </div>  
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinPVU">PVU : </label>      
        <div class="col-lg-8">
            <?php echo $this->Form->input('PVU',array('type'=>'text','placeholder'=>'PVU','class'=>'form-control')); ?>
        </div>         
    </div>   
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinDATELIVRAISON">Date de livraison : </label>
    ...
    <div class="form-group">
        <label class="col-lg-4 required" for="ExpressionbesoinComposantId">Composant : </label>
        <div class="col-lg-8">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4 required" for="ExpressionbesoinLotId">Lot : </label>
        <div class="col-lg-8">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinTypeId">Type d'environnement : </label>
        <div class="col-lg-8">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinVolumetrieId">Volumétrie : </label>
        <div class="col-lg-8">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinArchitectureId">Architecture : </label>
        <div class="col-lg-8">
            <?php if ($this->params->action == 'edit') { ?>
    ...
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinNOMUSAGE">Nom d'usage : </label>      
        <div class="col-lg-8">
            <?php echo $this->Form->input('NOMUSAGE',array('type'=>'text','placeholder'=>'Nom d\'usage','class'=>'form-control')); ?>
        </div>         
    </div>  
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinCONNECT">Connecté : </label>
        <div class="col-lg-5">
    ...
    <div class="form-group">
        <label class="col-lg-4" for="ExpressionbesoinDATEFIN">Date de fin : </label>
          <div class="col-lg-6" style="margin-left:15px;">
              <div class="input-group">
              <?php $today = new dateTime(); ?>
    ...
    <div class="form-group">
        <label class="col-lg-2" for="ExpressionbesoinCOMMENTAIRE">Commentaire : </label>       
        <div class="col-lg-10">
