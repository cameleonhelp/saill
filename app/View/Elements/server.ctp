<?php
    ...
    if(strtoupper($srv['Parameter']['param'])=='DEV') {
        echo '<div class="alert-box alert-devbox"  style="text-align:center !important;width:135px;margin-bottom:10px;">';
        echo __d('cake_dev', 'DEVELOPPEMENT');
        echo '</div>';	
    }
    if(strtoupper($srv['Parameter']['param'])=='DEMO') {
        echo '<div class="alert-box alert-demobox"  style="text-align:center !important;width:135px;margin-bottom:10px;">';
