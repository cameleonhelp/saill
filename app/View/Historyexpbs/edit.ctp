...
<?php echo $this->Form->create('Historyexpb'); ?>
	<fieldset>
		<legend><?php echo __('Edit Historyexpb'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Historyexpb.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Historyexpb.id'))); ?></li>
