<div class="volumetries index">
        <nav class="navbar toolbar marginright20">
                ...
                <?php echo $this->Form->create("Volumetry",array('action' => 'search', 'class'=>'toolbar-form pull-right','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?>
	...
	<tr>
            ...
            <td class="actions">
                ...
                <?php echo $this->Form->postLink('<span class="glyphicons bin showoverlay notchange"></span>', array('action' => 'delete',$volumetry['Volumetry']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer cette volumétrie')); ?>                    
                <?php endif; ?>                    
            </td>
	</tr>
<?php endforeach; ?>
