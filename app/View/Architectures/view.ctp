<div class="architectures view">
<h2><?php echo __('Architecture'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($architecture['Architecture']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('NOM'); ?></dt>
		<dd>
			<?php echo h($architecture['Architecture']['NOM']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('COMMENTAIRE'); ?></dt>
		<dd>
			<?php echo h($architecture['Architecture']['COMMENTAIRE']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($architecture['Architecture']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($architecture['Architecture']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Architecture'), array('action' => 'edit', $architecture['Architecture']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Architecture'), array('action' => 'delete', $architecture['Architecture']['id']), null, __('Are you sure you want to delete # %s?', $architecture['Architecture']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Architectures'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Architecture'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($architecture['Expressionbesoin'])): ?>
	...
	<?php foreach ($architecture['Expressionbesoin'] as $expressionbesoin): ?>
		<tr>
