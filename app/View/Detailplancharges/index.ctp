<div class="detailplancharges index">
    <?php echo $this->Form->create('Detailplancharge',array('id'=>'formValidate','class'=>'form-horizontal','action'=>'save','inputDefaults' => array('error'=>false,'label'=>false,'div' => false))); ?> 
