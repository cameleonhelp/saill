...
<div class="detailplancharges form">
    ...
    <table cellpadding="0" cellspacing="0" class="table table-bordered table-striped table-hover tablemax" id='detailplanchargeTable'>
        <thead>
	<tr>
			<th><label class="col-md-4 control-label required center">Utilisateur</label></th>
			<th><label class="col-md-4 control-label required center">Domaine</label></th>
			<th><label class="col-md-4 control-label required center">Projet/Activité</label></th>
			<th><?php echo 'Etp'; ?></th>
			<th><?php echo 'Jan.'; ?></th>
			<th><?php echo 'Fév.'; ?></th>
			<th><?php echo 'Mars'; ?></th>
	...
	<tr rowindex="0">
		<td class="tdmonth">
                    <?php echo $this->Form->select('Detailplancharge.0.utilisateur_id',$utilisateurs,array('data-rule-required'=>'true','class'=>'utilisateur form-control','data-msg-required'=>'Le nom de l\'utilisateur est obligatoire','empty' => 'Choisir un utilisateur')); ?>                    
                </td>
		<td class="tdmonth">
                    <?php echo $this->Form->select('Detailplancharge.0.domaine_id',$domaines,array('class'=>'form-control','data-rule-required'=>'true','data-msg-required'=>'Le nom du domaine est obligatoire','empty' => 'Choisir un domaine')); ?>                                        
                </td>
		<td class="tdmonth">
                <select name="data[Detailplancharge][0][activite_id]" class="form-control" data-rule-required="true" data-msg-required="Le nom de l'activité est obligatoire" id="Detailplancharge0ActiviteId"> 
		...
		<td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.ETP',array('class'=>'text-right form-control monthpc etp','style'=>'width:35px;','type'=>'text','value'=>'1.0')); ?></td>  
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.JANVIER',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-01-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.FEVRIER',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-02-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.MARS',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-03-01')))); ?></td>                
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.AVRIL',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-04-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.MAI',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-05-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.JUIN',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-06-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.JUILLET',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-07-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.AOUT',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-08-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.SEPTEMBRE',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-09-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.OCTOBRE',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-10-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.NOVEMBRE',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-11-01')))); ?></td>
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.DECEMBRE',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'text','value'=>nbJoursOuvres(new DateTime($annee.'-12-01')))); ?></td>
                ...
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.TOTAL',array('class'=>'text-right form-control rowTotal','style'=>'width:35px;margin-top:5px;margin-bottom:-9px;','type'=>'text','value'=>$total)); ?></td>
		<td style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.0.TJM',array('class'=>'text-right form-control','style'=>'width:35px;','type'=>'text','value'=>'')); ?></td>
                ...
                <td>
                    ...
                    <?php echo $this->Form->input('Detailplancharge.0.COUT',array('class'=>'text-right form-control monthpc','style'=>'width:35px;','type'=>'hidden')); ?>
		</td>
	</tr>
	<tr id="templateRow">
		<td class="tdmonth">
                    <?php echo $this->Form->select('Detailplancharge.¤.utilisateur_id',$utilisateurs,array('class'=>'newselect utilisateur form-control','data-msg-required'=>'Le nom de l\'utilisateur est obligatoire','empty' => 'Choisir un utilisateur')); ?>                    
                </td>
		<td class="tdmonth">
		...
		<td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.¤.ETP',array('class'=>'text-right form-control monthpc etp newetp','style'=>'width:35px;','type'=>'text','value'=>'1.0')); ?></td>  
                ...
                <?php $total = nbJoursOuvres(new DateTime($annee.'-01-01')) + nbJoursOuvres(new DateTime($annee.'-02-01')) + nbJoursOuvres(new DateTime($annee.'-03-01'))+ nbJoursOuvres(new DateTime($annee.'-04-01'))+ nbJoursOuvres(new DateTime($annee.'-05-01'))+ nbJoursOuvres(new DateTime($annee.'-06-01')); ?>
                <?php $total += nbJoursOuvres(new DateTime($annee.'-07-01')) + nbJoursOuvres(new DateTime($annee.'-08-01')) + nbJoursOuvres(new DateTime($annee.'-09-01'))+ nbJoursOuvres(new DateTime($annee.'-10-01'))+ nbJoursOuvres(new DateTime($annee.'-11-01'))+ nbJoursOuvres(new DateTime($annee.'-12-01')); ?>                
                <td class="tdmonth" style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.¤.TOTAL',array('class'=>'text-right form-control rowTotal','style'=>'width:35px;margin-top:5px;margin-bottom:-9px;','type'=>'text','value'=>$total)); ?></td>
		<td style='text-align: center;'><?php echo $this->Form->input('Detailplancharge.¤.TJM',array('class'=>'text-right form-control','style'=>'width:35px;','type'=>'text','value'=>'')); ?></td>
                ...
                <td>
                    ...
                    <?php echo $this->Form->input('Detailplancharge.¤.COUT',array('class'=>'text-right','style'=>'width:35px;','type'=>'hidden')); ?>
		</td>
	</tr>
        </tbody>
        <tfoot>
