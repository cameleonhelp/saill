...
<div class="actions form">
    ...
    <div class='block-panel block-panel-50-left'>
        ...
        <div class="form-group">
            <label class="col-lg-4 required" for="ActionSTART">Sur la période du: </label>
            <div class="col-lg-6">
        ...
        <div class="form-group">
            <label class="col-lg-4 required"  for="ActionRepartitionUtilisateur">Afficher répartition par utilisateur : </label>
    ...
    <div class='block-panel block-panel-50-right'>
        ...
        <div class="form-group">
            <label class="col-lg-4 required" for="ActionEND">au : </label>
            <div class="col-lg-6">
              <div class="input-group">
              <?php $today = new dateTime(); ?>
        ...
        <div class="form-group">
            <label class="col-lg-4 required"  for="ActionDetail">Rapport Détaillé : </label>
