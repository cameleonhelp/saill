<div class="assoprojetentites index">
	<h2><?php echo __('Assoprojetentites'); ?></h2>
	...
	<?php foreach ($assoprojetentites as $assoprojetentite): ?>
	<tr>
		<td><?php echo h($assoprojetentite['Assoprojetentite']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($assoprojetentite['Assoprojetentite']['created']); ?>&nbsp;</td>
		<td><?php echo h($assoprojetentite['Assoprojetentite']['modified']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $assoprojetentite['Assoprojetentite']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $assoprojetentite['Assoprojetentite']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $assoprojetentite['Assoprojetentite']['id']), null, __('Are you sure you want to delete # %s?', $assoprojetentite['Assoprojetentite']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
