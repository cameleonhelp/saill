<div class="perimetres view">
<h2><?php echo __('Perimetre'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($perimetre['Perimetre']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('NOM'); ?></dt>
		<dd>
			<?php echo h($perimetre['Perimetre']['NOM']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($perimetre['Perimetre']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($perimetre['Perimetre']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Perimetre'), array('action' => 'edit', $perimetre['Perimetre']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Perimetre'), array('action' => 'delete', $perimetre['Perimetre']['id']), null, __('Are you sure you want to delete # %s?', $perimetre['Perimetre']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Perimetres'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Perimetre'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($perimetre['Expressionbesoin'])): ?>
	...
	<?php foreach ($perimetre['Expressionbesoin'] as $expressionbesoin): ?>
		<tr>
