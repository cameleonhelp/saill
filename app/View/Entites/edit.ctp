...
<?php echo $this->Form->create('Entite'); ?>
	<fieldset>
		<legend><?php echo __('Edit Entite'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Entite.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Entite.id'))); ?></li>
