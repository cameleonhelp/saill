<div class="equipes index">
	...
	<tr>
		...
		<td><?php echo h($equipe['Equipe']['utilisateur_id']); ?>&nbsp;</td>
		<td><?php echo h($equipe['Equipe']['agent']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $equipe['Equipe']['id']), null, __('Are you sure you want to delete # %s?', $equipe['Equipe']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
