	...
	<tr>
		...
		<td class="actions">
		    ...
		    <?php endif; ?>
                    ...
                    <?php echo $contrat['Tjmcontrat']['id']>1 ? $this->Form->postLink('<span class="glyphicons showoverlay bin notchange"></span>', array('action' => 'delete', $contrat['Contrat']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer ce contrat ?')):''; ?>
                    <?php endif; ?>
                </td>
	</tr>
        <?php endforeach; ?>
