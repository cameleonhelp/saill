<div class="sites index">
	...
	<tr>
		...
		<td class="actions">
                    ...
                    <?php echo $this->Form->postLink('<span class="glyphicons bin showoverlay notchange"></span>', array('action' => 'delete', $site['Site']['id']),array('escape' => false), __('Etes-vous certain de vouloir supprimer ce site ?')); ?>
                    <?php endif; ?>
		</td>
	</tr>
        <?php endforeach; ?>
