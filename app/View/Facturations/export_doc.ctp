...
<p><b>Rapport sur les jours facturés<b></p>
<br />
<p><b>Date :<b>
...
<br />
<p style="text-align: center;">Nombre de jour facturés par projet</p><br>
<table  cellpadding="0" cellspacing="0">
		...
		<?php foreach($rowsrapport as $row):
			echo '<tr>'; ?>
                        ...
                        <td class="tableTdContent"><?php echo $row['Facturation']['projet_NOM']; ?></td>
...
<br />
<p style="text-align: center;">Nombre de jours facturés par projet et activité</p><br>
<table  cellpadding="0" cellspacing="0">
	</tr>
		<tr id="titles">
			<td class="tableTd">Période</td>
...
<?php if (isset($rowsrepartition)) : ?>
<br />
<p style="text-align: center;">Nombre de jours facturés par utilisateur et par activité</p><br>
<table  cellpadding="0" cellspacing="0">
	</tr>
		<tr id="titles">
			<td class="tableTd">Période</td>
		...
		<?php foreach($rowsrepartition as $row):
			echo '<tr>'; ?>
                        <td class="tableTdContent"><?php echo strMonth($row[0]['MONTH']).' '.$row[0]['YEAR']; ?></td>
