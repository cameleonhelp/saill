<div class="facturations index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('activitesreelle_id'); ?></th>
			...
			<th><?php echo $this->Paginator->sort('NUMEROFTGALILEI'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($facturation['Facturation']['activitesreelle_id']); ?>&nbsp;</td>
