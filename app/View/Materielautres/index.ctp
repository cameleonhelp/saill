<div class="materielautres index">
        <div class="navbar">
            <div class="navbar-inner">
                ...
                <?php echo $this->Form->create("Materielautre",array('action' => 'search','class'=>'navbar-form clearfix pull-right','inputDefaults' => array('label'=>false,'div' => false))); ?>
	...
	<tr>
		...
		<td><?php echo $materielautre['Materielautre']['COMMENTAIRE']; ?>&nbsp;</td>
		<td class="actions">
