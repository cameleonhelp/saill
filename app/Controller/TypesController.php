...
class TypesController extends AppController {
    ...
    /**
     * filtre le s environnements par le statut actif
     * 
     * @param string $id
     * @return string
     */
    ...
    /**
     * filtre les environnement par entité
     * 
     * @param string $id
     * @param string $visibility
     * @return string
    ...
    /**
     * mise à jour dynamique de l'environnement
     */
    ...
    /**
     * renvois la liste des environnements pour les selects
     * 
     * @param string $actif
     * @return array
     */
    ...
    /**
     * renvois la liste des environnements 
     * 
     * @param string $actif
     * @return array
     */
    ...
    /**
     * renvois l'environnement à partir de son nom
     * 
     * @param string $nom
     * @return array 
     */
