...
class UtiliseoutilsController extends AppController {
    ...
    /**
     * duplique des droits depuis un utilisateur
     */
    ...
    public function get_restriction(){
        if (userAuth('WIDEAREA')==0 && (userAuth('section_id')!='' || userAuth('section_id')!=null)) :
    ...
    /**
     * filtre les dsroits par utilisateur
     * 
     * @param string $id
    ...
    /**
     * met à jour l'état (workflow)
     * 
     * @param string $old_etat
     * @param string $valideur
     * @return string
     */
    ...
    /**
     * renvois tous les droits pour un utilisateur
     * 
     * @param string $visibility
    ...
    /**
     * renvois la liste des droits pour un utilisateur
     * 
     * @param string $visibility
     * @param string $restriction
     * @return array
    ...
    /**
     * renvois la liste des utilisateurs
     * 
     * @return json
     */
    ...
    /**
     * renvois les lsites de diffusion
     * 
     * @return json
     */
    ...
    /**
     * ajoute des droits à un utilisateur
     */
    ...
    /**
     * ajoute et/ou met à jour le droits
     * 
     * @param string $utilisateur_id
     * @param string $droit_id
     * @param string $type
     * @param string $duplique
     */
    ...
    /**
     * met à jour le statut d'ouverture du droit
     * 
     * @param string $id
     * @throws NotFoundException
     * @throws UnauthorizedException
    ...
    public function progressstate($id = null) {
        ...
        if (isAuthorized('utiliseoutils', 'update')) :
            ...
            if(@$record['Outil']['VALIDATION']==0 && $record['Utiliseoutil']['STATUT']=='Pris en compte'): $record['Utiliseoutil']['STATUT']='Validé'; endif;
            ...
            if ($this->Utiliseoutil->save($record)) { 
                ...
                if($getnewetat['newetat']=='Demande transférée' || $getnewetat['newetat']=='A supprimer' || $getnewetat['newetat'] = 'En validation'):
    ...
    /**
     * mise à jour automatique de l'ouverture du droit
     * 
     * @param string $id
     */
    ...
    /**
     * envois un mail en fonction de l'avancement d'ouverture du droit
     * 
     * @param string $id
     * @param string $userid
     */
    ...
    /**
     * recherche d'ouverture de droit
     * 
     * @param string $filtreetat
     * @param string $utilisateur_id
     * @param string $filtreoutil
    ...
    /**
     * met à jour plusieurs ouvertures de droits
     * 
     * @param string $ids
     * @return json
     */
    ...
    /**
     * supprime plusieurs ouvertures de droit
     * 
     * @param string $ids
     * @return json
     */
    ...
    /**
     * envois un mail de relance
     * 
     * @param array $utiliseoutil_id
     */
    ...
    /**
     * ajoute un modèle d'ouverture de droits par défaut pour une entité
     */
    ...
    /**
     * renvois la liste des outils possible (liste de diffusion et partages)
     * 
     * @param string $id d'un utilisateur
     * @return array
     */
    ...
    /**
     * renvois les compteurs d'ouvertures de droits pour un utilisateur
     * 
     * @param string $id
     * @return array
     */
