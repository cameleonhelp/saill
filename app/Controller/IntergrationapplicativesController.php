...
class IntergrationapplicativesController extends AppController {
    ...
    /**
     * renvois la limité de visibilité
     * 
     * @return string
     */
    ...
    /**
     * sauvegarde en cache les données pour l'export
     * 
    ...
    /**
     * liste des intégrations applicatives en fonction des filtres
     * 
     * @param string $aplication
     * @param string $installe
     * @param string $valide
    ...
    /**
     * ajoute une intégration applicative
     *
     * @return void
     */
    public function add() {
    ...
    /**
     * modification de l'intégration applicative
     *
    ...
    /**
     * supprime l'intégration applicative
     * 
     * @param string $id
     * @param boolean $loop
     * @return boolean
    ...
    /**
     * modification dynamique du statut installé (Ajax)
     * 
     * @param string $id
     * @return boolean
     */
    ...
    /**
     * modification dynamique du statut valid (Ajax)
     * 
     * @param string $id
     * @return boolean
     */
    ...
    /**
     * duplication d'une intégration applicative
     *
     * @throws NotFoundException
    ...
    /**
     * enregistre un historique de l'intégration applicative
     * 
     * @param string $id
     * @param string $msg
     * @throws UnauthorizedException
    ...
    /**
     * recherche d'intégrations applicatives en fonction des filtres
     * 
     * @param string $aplication
     * @param string $installe
     * @param string $valide
    ...
    /**
     * modification en masse du statuit installé (Ajax)
     * 
     * @param string $id
     * @return json
     */
    ...
    /**
     * modification en masse du statut validé
     * 
     * @param string $id
     * @return json
     */
    ...
    /**
     * calcul du rapport sur les intégrations applicatives
     * 
     * @throws UnauthorizedException
     */
