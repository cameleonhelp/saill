...
App::uses('ChangelogversionsController', 'Controller');
...
class ChangelogdemandesController extends AppController {
    ...
    /**
     * liste toutes les demandes pour une version
     * 
     * @param int $id d'une version
     */
    ...
    /**
     * change l'état de la demande (Ajax)
     * 
     * @param int $id
     * @return boolean
     */
    ...
    /**
     * renvois les informations concernant la demande
     * 
     * @param int $id
     * @return array
     */
    ...
    /**
     * envois un mail pour demander de traiter la demande
     * 
     * @param array $obj
     */
    ...
    /**
     * export au format Excel des demandes
     */
    function export_xls() {
            $changelogetats = Configure::read('changelogEtatDemande');  
            $changelogtypes = Configure::read('changelogType');  
