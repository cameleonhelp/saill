...
class EnvoutilsController extends AppController {
    ...
    /**
     * calcul le périmétre de visibilité
     * 
     * @return null
     */
    ...
    /**
     * limite le perimetre de visibilité
     * 
    ...
    /**
     * filtre les outils par le statut actif
     * 
     * @param string $id
     * @return string
     */
    ...
    /**
     * filtre les outils par l'entité
     * 
     * @param string $id
     * @param string $visibility
     * @return string
    ...
    /**
     * change le statut de l'outil de façon dynamique (Ajax)
     */
    ...
    /**
     * renvois la liste des OS uniquement
     * 
     * @param boolean $actif
     * @return array
     */
    ...
    /**
     * renvois la liste de tous les outils
     * 
     * @param boolean $actif
     * @return array
     */
    ...
    /**
     * renvois la liste des outils (logiciels uniquement)
     * 
     * @param boolean $actif
     * @return array
     */
    ...
    /**
     * renvois l'outil à partir de son nom
     * 
     * @param string $nom
     * @return array
     */
