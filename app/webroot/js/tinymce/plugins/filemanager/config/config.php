...
$pathname = $_SERVER['HTTP_HOST']=="saill.dsit.sncf.fr" ? "" : $ds.$uri[1].$ds.$uri[2];
$baseurl = $host.$pathname;
$base_url=$baseurl;  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = '/files/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = '../../../../files/source/'; // relative path from filemanager folder to upload folder (with final /)
