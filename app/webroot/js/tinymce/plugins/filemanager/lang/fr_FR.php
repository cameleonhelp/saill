...
define('lang_Upload_base_help',"Glisser et déposer les fichiers dans ce cadre ou cliquer pour ouvrir la boite de dialogue pour insérer un fichier.");
define('lang_Type_dir','dossier');
...
define('lang_Show_url','montrer URL');
define('lang_Extract','extraire ici');
define('lang_File_info','information du fichier');
define('lang_Edit_image','modifier image');
